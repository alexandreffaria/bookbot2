# Generate a report based on a book (.txt)

## Use:
change this line in main() to the book you wanna report. (or change the script to accept it from the cli :x)
- bookPath = "books/frank.txt" 

## Report ex:
```
--- Begin report of frank.txt ---
